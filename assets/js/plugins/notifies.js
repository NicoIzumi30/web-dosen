 ...
 * Notifies
 *
 * Interface.Plugins.Notify.html page content scripts. Initialized from scripts.js file.
 *
 *
 */
...
class Notifies {
  ...
  _initImage() {
    jQuery('#notifyButtonImage').on('click', (event) => {
      event.preventDefault();
      jQuery.notify({title: 'Hello World!', message: '', icon: 'img/profile/profile-1.jpg'}, {type: 'primary', icon_type: 'image'});
    });
  }
